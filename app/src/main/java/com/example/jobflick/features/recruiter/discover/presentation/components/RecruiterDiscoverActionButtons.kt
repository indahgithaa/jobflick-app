package com.example.jobflick.features.recruiter.discover.presentation.components
...
@Composable
fun RecruiterDiscoverActionButtons(
    ...
    Row(
        ...
        ActionButton("Hubungi", GreenApply, R.drawable.check, onContact)
